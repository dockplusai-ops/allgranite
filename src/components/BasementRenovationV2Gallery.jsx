...
const BasementRenovationV2Gallery = () => {
  ...
  const openLightbox = (index) => {
    ...
    trackEvent({
      event: 'basement_renovation_gallery_view',
      image_index: index,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-body max-w-2xl mx-auto">
              See the basement transformations we've created for Cape Cod families
            </p>
          </div>
...
export default BasementRenovationV2Gallery
