...
import { trackBathroomRenovationPhoneClick, trackBathroomRenovationCTAClick } from '../utils/gtm'

const BathroomV2FinalCTA = () => {
    ...
    <section className="relative w-full py-20 md:py-32 px-4 lg:px-8 overflow-hidden bg-gradient-to-br from-navy via-navy/95 to-navy">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-white/90 font-body mb-12 max-w-2xl mx-auto">
          Join 400+ Cape Cod families who transformed their bathrooms with us
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="tel:5083757785"
            onClick={() => trackBathroomRenovationPhoneClick('final_cta_primary')}
          ...
          <button
            onClick={() => {
              trackBathroomRenovationCTAClick('get_quote', 'final_cta')
              handleScrollToForm()
            }}
...
export default BathroomV2FinalCTA
