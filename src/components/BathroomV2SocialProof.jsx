...
const BathroomV2SocialProof = () => {
  const stats = [
    { number: '400+', label: 'Bathrooms Renovated' },
  ...
  const testimonials = [
    {
      quote: "Our bathroom transformation exceeded all expectations. The team was professional, the design was perfect, and the installation was flawless.",
      name: "Sarah M.",
      location: "Barnstable",
      rating: 5
    },
    ...
    {
      quote: "The complete bathroom renovation was done in just 10 days as promised. The attention to detail is remarkable. Our bathroom is now a spa-like retreat.",
      name: "Lisa T.",
      location: "Dennis",
      rating: 5
    }
...
export default BathroomV2SocialProof
