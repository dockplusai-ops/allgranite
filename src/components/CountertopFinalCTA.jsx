...
import { trackCountertopServicePhoneClick, trackCountertopServiceCTAClick } from '../utils/gtm'

const CountertopFinalCTA = () => {
    ...
    <section className="relative w-full py-20 md:py-32 px-4 lg:px-8 overflow-hidden bg-gradient-to-br from-navy via-navy/95 to-navy">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `url('https://res.cloudinary.com/dhrxy4yo0/image/upload/f_webp,q_30,w_1920/v1762535825/3_wqvvt2.webp')`,
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-white/90 font-body mb-12 max-w-2xl mx-auto">
          Join 1000+ Cape Cod homeowners who chose premium countertops from us
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="tel:5083757785"
            onClick={() => trackCountertopServicePhoneClick('final_cta_primary')}
          ...
          <button
            onClick={() => {
              trackCountertopServiceCTAClick('get_quote', 'final_cta')
              handleScrollToForm()
            }}
...
export default CountertopFinalCTA
