...
const InteriorPaintingV2Gallery = () => {
  ...
  const openLightbox = (index) => {
    ...
    trackEvent({
      event: 'interior_painting_gallery_view',
      image_index: index,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-body max-w-2xl mx-auto">
              See the painting transformations we've created for Cape Cod families
            </p>
          </div>
...
export default InteriorPaintingV2Gallery
