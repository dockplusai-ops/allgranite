...
import { trackInteriorRenovationPhoneClick, trackInteriorRenovationCTAClick } from '../utils/gtm'

const InteriorRenovationV2FinalCTA = () => {
    ...
    <section className="relative w-full py-20 md:py-32 px-4 lg:px-8 overflow-hidden bg-gradient-to-br from-navy via-navy/95 to-navy">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-white/90 font-body mb-12 max-w-2xl mx-auto">
          Join 300+ Cape Cod families who transformed their interiors with us
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="tel:5083757785"
            onClick={() => trackInteriorRenovationPhoneClick('final_cta_primary')}
          ...
          <button
            onClick={() => {
              trackInteriorRenovationCTAClick('get_quote', 'final_cta')
              handleScrollToForm()
            }}
...
export default InteriorRenovationV2FinalCTA
