...
import { trackTileFlooringPhoneClick, trackTileFlooringFormSubmit } from '../utils/gtm'

const TileFlooringV2Form = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl md:text-2xl text-white/90 font-body mb-8 leading-relaxed">
              Tell us about your tile and flooring project. We'll send you a detailed estimate within 24 hours.
            </p>
            ...
            <div className="pt-8 border-t border-white/20">
              ...
              <a
                href="tel:5083757785"
                onClick={() => trackTileFlooringPhoneClick('form_section')}
...
export default TileFlooringV2Form
