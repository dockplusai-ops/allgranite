...
import { trackTileFlooringPhoneClick, trackTileFlooringCTAClick, trackPhoneClick } from '../utils/gtm'

const TileFlooringV2Hero = () => {
  ...
  const handleScrollToForm = () => {
    const element = document.querySelector('#tile-flooring-form')
    if (element) {
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 lg:px-8 pt-32">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold text-white mb-6 leading-tight">
            Premium Tile
            <span className="block text-gold mt-2" style={{ textShadow: '0 2px 8px rgba(0, 0, 0, 0.5), 0 4px 16px rgba(0, 0, 0, 0.3)' }}>& Flooring</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl lg:text-3xl text-white/90 font-body font-light mb-12 max-w-3xl mx-auto">
            Expert tile and flooring installation. Premium materials, professional installation, lasting beauty. Transform your floors with Cape Cod's best.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <a
              href="tel:5083757785"
              onClick={() => trackTileFlooringPhoneClick('hero_primary')}
            ...
            <button
              onClick={() => {
                trackTileFlooringCTAClick('get_quote', 'hero')
                handleScrollToForm()
              }}
...
export default TileFlooringV2Hero
